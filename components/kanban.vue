<template>
  <div>
    <div class="column" data-column="1">
      <h3>Column 1</h3>
      <draggable v-model="column1Items" :options="columnOptions"  :change="cloneAction" :move="moveAction" data-column="1">
        <div v-for="(item, index) in column1Items" :key="index">{{ item }}</div>
      </draggable>
    </div>
    <div class="column" data-column="2">
      <h3>Column 2</h3>
      <draggable v-model="column2Items" :options="columnOptions"  :change="cloneAction" :move="moveAction" data-column="2">
